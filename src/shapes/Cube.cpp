...
void Cube::makeTile(glm::vec3 topLeft,
    ...
    glm::vec3 V = bottomRight - topLeft;
...
void Cube::makeFace(glm::vec3 topLeft,
    ...
    for (int r = 0; r < m_param1; r++) {
        for (int c = 0; c < m_param1; c++) {
            glm::vec3 tl = topLeft + (float)c * dx + (float)r * dy;
            glm::vec3 tr = topLeft + (float)(c+1) * dx + (float)r * dy;
            glm::vec3 bl = topLeft + (float)c * dx + (float)(r+1) * dy;
            glm::vec3 br = topLeft + (float)(c+1) * dx + (float)(r+1) * dy;
